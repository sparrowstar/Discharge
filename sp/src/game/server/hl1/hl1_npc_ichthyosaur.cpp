...
ConVar sk_ichthyosaurhl_shake ( "sk_ichthyosaurhl_shake", "0" );
...
//=========================================================
void CNPC_IchthyosaurHL::Precache()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_IchthyosaurHL::Spawn( void )
{
	Precache( );
	...
	SetTouch( &CNPC_IchthyosaurHL::BiteTouch );
...
//=========================================================
//=========================================================
int CNPC_IchthyosaurHL::TranslateSchedule( int scheduleType )
{
	switch	( scheduleType )
	{
...
int CNPC_IchthyosaurHL::SelectSchedule()
{
	switch(m_NPCState)
	{
	case NPC_STATE_IDLE:
...
bool CNPC_IchthyosaurHL::OverrideMove( float flInterval )
{
...
// Purpose:
//-----------------------------------------------------------------------------
void CNPC_IchthyosaurHL::MoveExecute_Alive(float flInterval)
{
...
void CNPC_IchthyosaurHL::InputStartCombat( inputdata_t &input )
{
	m_bOnAttack = true;
}

void CNPC_IchthyosaurHL::InputEndCombat( inputdata_t &input )
{
	m_bOnAttack = false;
}
...
// schedule.
//=========================================================
void CNPC_IchthyosaurHL::StartTask(const Task_t *pTask)
{
	switch (pTask->iTask)
	{
...
void CNPC_IchthyosaurHL::RunTask(const Task_t *pTask )
{
...
// Output : int
//-----------------------------------------------------------------------------
int CNPC_IchthyosaurHL::MeleeAttack1Conditions( float flDot, float flDist )
{
...
//=========================================================
int CNPC_IchthyosaurHL::RangeAttack1Conditions( float flDot, float flDist )
{
...
void CNPC_IchthyosaurHL::BiteTouch( CBaseEntity *pOther )
{
...
//=========================================================
void CNPC_IchthyosaurHL::HandleAnimEvent( animevent_t *pEvent )
{
	...
	case ICHTHYOSAUR_AE_SHAKE_LEFT:
		{
			...
			if (hEnemy != NULL && FVisible( hEnemy ))
			{
				...
				if (DotProduct( vecShootDir, vForward ) > 0.707)
				{
					...
					CTakeDamageInfo info( this, this, sk_ichthyosaurhl_shake.GetInt(), DMG_SLASH );
...
// relationship table.
//=========================================================
Class_T CNPC_IchthyosaurHL::Classify ( void )
{
	return	CLASS_ALIEN_MONSTER;
}

void CNPC_IchthyosaurHL::NPCThink ( void )
{
	// blink the eye
...
//-----------------------------------------------------------------------------
float CNPC_IchthyosaurHL::GetGroundSpeed( void )
{
	if ( GetIdealActivity() == ACT_GLIDE )
...
Vector CNPC_IchthyosaurHL::DoProbe( const Vector &Probe )
{
...
bool CNPC_IchthyosaurHL::ProbeZ( const Vector &position, const Vector &probe, float *pFraction)
{
...
//-----------------------------------------------------------------------------
bool CNPC_IchthyosaurHL::FVisible( CBaseEntity *pEntity, int traceMask, CBaseEntity **ppBlocker )
{
...
void CNPC_IchthyosaurHL::IdleSound( void )	
{ 
	CPASAttenuationFilter filter( this );
	EmitSound( filter, entindex(), "Ichthyosaur.Idle" );
}

void CNPC_IchthyosaurHL::AlertSound( void ) 
{ 
	CPASAttenuationFilter filter( this );
	EmitSound( filter, entindex(), "Ichthyosaur.Alert" );
}

void CNPC_IchthyosaurHL::AttackSound( void ) 
{ 
	CPASAttenuationFilter filter( this );
	EmitSound( filter, entindex(), "Ichthyosaur.Attack" );
}

void CNPC_IchthyosaurHL::BiteSound( void ) 
{ 
	CPASAttenuationFilter filter( this );
	EmitSound( filter, entindex(), "Ichthyosaur.Bite" );
}

void CNPC_IchthyosaurHL::DeathSound( const CTakeDamageInfo &info ) 
{ 
	CPASAttenuationFilter filter( this );
	EmitSound( filter, entindex(), "Ichthyosaur.Die" );
}

void CNPC_IchthyosaurHL::PainSound( const CTakeDamageInfo &info )	
{ 
	CPASAttenuationFilter filter( this );
...
//-----------------------------------------------------------------------------
void CNPC_IchthyosaurHL::GatherEnemyConditions( CBaseEntity *pEnemy )
{
	// Do the base class
