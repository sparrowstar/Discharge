...
#if defined( CSTRIKE_DLL ) || defined (SDK_DLL )|| defined( DISCHARGE_CLIENT )
...
#if defined( CSTRIKE_DLL ) || defined( DISCHARGE_CLIENT )
...
#if defined( HL1_CLIENT_DLL )|| defined( DISCHARGE_CLIENT )
