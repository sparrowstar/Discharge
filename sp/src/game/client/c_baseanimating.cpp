...
ConVar	discharge_original_muzzleflash("discharge_original_muzzleflash", "0", FCVAR_ARCHIVE, "If 1, use original HL2 Muzzleflash.\n If 0, use Discharge's better flash\n");
...
void C_BaseAnimating::ProcessMuzzleFlashEvent()
{
	...
	{
		if (discharge_original_muzzleflash.GetBool())
		{
