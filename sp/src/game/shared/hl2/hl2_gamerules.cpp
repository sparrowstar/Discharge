...
ConVar	sk_plr_dmg_ociw			( "sk_plr_dmg_ociw","0", FCVAR_REPLICATED );
ConVar	sk_npc_dmg_ociw			( "sk_npc_dmg_ociw","0", FCVAR_REPLICATED);
ConVar	sk_max_ociw				( "sk_max_ociw","0", FCVAR_REPLICATED);
...
ConVar	sk_plr_dmg_launcher_grenade	("sk_plr_dmg_launcher_grenade", "0", FCVAR_REPLICATED);
ConVar	sk_npc_dmg_launcher_grenade	("sk_npc_dmg_launcher_grenade", "0", FCVAR_REPLICATED);
ConVar	sk_max_launcher_grenade		("sk_max_launcher_grenade", "0", FCVAR_REPLICATED);
...
CAmmoDef *GetAmmoDef()
{
	...
	if ( !bInitted )
	{
		...
		def.AddAmmoType("OCIW",				DMG_BULLET,					TRACER_LINE_AND_WHIZ,	"sk_plr_dmg_ociw",			"sk_npc_dmg_ociw",			"sk_max_ociw",			BULLET_IMPULSE(200, 1225), 0 );
		...
		def.AddAmmoType("AWPRound",			DMG_BULLET,					TRACER_NONE,			"sk_plr_dmg_sniper_round",	"sk_npc_dmg_sniper_round",	"sk_max_sniper_round",	BULLET_IMPULSE(650, 6000), 0 );
...
//		def.AddAmmoType("Extinguisher",		DMG_BURN,					TRACER_NONE,			0,	0, 100, 0, 0 );
		...
		// Fucking good story, 10 outa 10 -Rara
		//===================================================================== 
