...
#include "in_buttons.h"
	...
	#include "../../server/discharge/npc_secobmodportal1.h"
	#include "../../server/discharge/npc_secobmodportal2.h"
...
void CWeaponPortalGun::Precache( void )
{
	...
	PrecacheSound("sound/player/portal_exit1.wav");
	PrecacheSound("sound/player/portal_exit2.wav");
	PrecacheSound("sound/player/portal_enter1.wav");
	PrecacheSound("sound/player/portal_enter2.wav");
...
EmitSound( "Weapon_Portalgun.fire_blue" );
	...
	CPortalBolt *pBolt = CPortalBolt::BoltCreate( vecSrc, angAiming, GetWpnData().m_iPlayerDamage, pOwner );
...
EmitSound( "Weapon_Portalgun.fire_red" );
	...
	CPortalBolt *pBolt2 = CPortalBolt::BoltCreate2( vecSrc, angAiming, GetWpnData().m_iPlayerDamage, pOwner );
